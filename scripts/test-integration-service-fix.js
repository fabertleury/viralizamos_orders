...
async function testIntegrationFlow() {
  ...
  try {
    ...
    const mockOrderData = {
      ...
      service_id: null, // Não usar service_id local para evitar erros de chave estrangeira
    ...
    const order = await prisma.order.create({
      data: {
        ...
        metadata: {
          service_id_supabase: service.id, // Armazenar o ID do serviço do Supabase nos metadados
    ...
    console.log(`
Resumo:
- Serviço Supabase: ${service.name} (ID: ${service.id})
- Serviço ID externo: ${service.external_id}

...
exports.categoryResolvers = {
    Query: {
        ...
        categoriesBySocial: async (_, { socialId }) => {
            try {
                return await prisma.category.findMany({
        ...
        deleteCategory: async (_, { id }) => {
            try {
                ...
                if (subcategoriesCount > 0) {
                    throw new Error('Não é possível excluir esta categoria pois existem subcategorias associadas a ela');
                }
                ...
                if (servicesCount > 0) {
                    throw new Error('Não é possível excluir esta categoria pois existem serviços associados a ela');
                }

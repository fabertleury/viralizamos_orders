...
exports.statusCheckQueue = exports.pendingOrdersQueue = exports.initScheduler = void 0;
const bull_1 = __importDefault(require("bull"));
const axios_1 = __importDefault(require("axios"));
const process_order_1 = require("./process-order");
...
const pendingOrdersQueue = new bull_1.default('pending-orders-processing', process.env.REDIS_URL);
exports.pendingOrdersQueue = pendingOrdersQueue;
const statusCheckQueue = new bull_1.default('order-status-check', process.env.REDIS_URL);
exports.statusCheckQueue = statusCheckQueue;
    ...
    try {
        ...
        for (const order of processingOrders) {
            try {
                ...
                const response = await axios_1.default.post(order.provider.api_url, statusPayload);
                // Processar resposta
...
const initScheduler = () => {
    ...
    pendingOrdersQueue.add({ limit: 10 }, {

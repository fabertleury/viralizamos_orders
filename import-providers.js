...
async function importProviders() {
  console.log('Importando provedores...');
  ...
  try {
    ...
    for (const provider of providersData) {
      try {
        ...
        if (existingProvider) {
          ...
          console.log(`Provedor atualizado: ${updated.name} (${updated.id})`);
          results.push({
            id: updated.id,
            action: 'updated',
            name: updated.name
          ...
          console.log(`Provedor criado: ${created.name} (${created.id})`);
          results.push({
            id: created.id,
            action: 'created',
            name: created.name
    ...
    console.log('Provedores importados:', results.length);
